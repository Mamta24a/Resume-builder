...
<body background="CV-Writing.png" no repeat style="background-size:100%;background-repeat:no repeat center fixed;background-attachment:fixed">

<div class="container"><br>
    <ul class="nav nav-tabs" style="opacity:0.5">
    <li class="active" ><a data-toggle="tab" href="#home" style="font-weight:bold" ><i class="fa fa-file-text-o" aria-hidden="true"></i> Create Resume</a></li>
    <li><a data-toggle="tab" href="#menu1" style="font-weight:bold"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Resume</a></li>
    <li><a data-toggle="tab" href="#menu2" style="font-weight:bold"><i class="fa fa-print" aria-hidden="true"></i> / <i class="fa fa-download" aria-hidden="true"></i> Print/ Download Resume</a></li>
  </ul>
...
#outline {
	...
	opacity:0.9;
      ...
      <div id="outline"><br>
      <form action="resumeout.php" method="post" enctype="multipart/form-data">
    ...
    <div id="menu1" class="tab-pane fade">
      <h3 style="color:#f2f2f2">Edit Your New Acheivements here...</h3>
...
if(isset($_POST['update'])){	 
			 $update_querry = "UPDATE rsmtbl2 SET 
			 name = '$_POST[name]', email = '$_POST[email]', phno = '$_POST[phno]', address = '$_POST[address]', objc = '$_POST[objc]', 
			 ...
			 qualities='$_POST[qualities]', backlog='$_POST[backlog]' WHERE email='$_POST[hidden]' ";  
			 
			 if(mysql_query($update_querry, $con)) {
				 
				 echo "<script>alert ('Post has been updated')</script>";
				 
				 //echo "<script>window.open('resume.php','_self')</script>";
		}else echo "error in upload querry";
//end of update......	*/	
...
//else { $msg = "error in img"; } 
    ...
    $sql="SELECT * FROM rsmtbl2 WHERE  email='".$_SESSION['email']."'  ";
      ...
      <div id="outline"><br>
      <form action="mainstu.php" method="post" enctype="multipart/form-data">
	     <h1 style="color:lightseagreen" align="center">RESUME</h1>
	    <h3 style="color:lightseagreen" align="center">BASIC INFORMATION:</h3>
           <label>Full Name:</label><br>
		   ...
		   <input type="hidden" name="hidden" value="<?php echo $email; ?>" ><br>
		   <label>Phone Number:</label><br>
	...
	<h3 style="color:#f2f2f2">Fill the form to print or download your fresh details...</h3>
      <div id="outline"><br>
      ...
      <option value="Master of Technology">Master of Technology</option>
		  ...
		  <textarea name="skills" ><?php echo $skills; ?></textarea><br>
		   ...
		   <input type="submit" value="Print it out!!   or   Download as PDF" name="submit">
