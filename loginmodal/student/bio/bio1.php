...
spcl='$_POST[spcl]',
bl='$_POST[bl]',
ex='$_POST[ex]' 	WHERE roll='$_POST[hidden]' ";  
...
//end of update......	
   ...
   <div id="menu1" class="tab-pane fade">
	  ...
	  <div id="bio-box">
      <form action="bio1.php" method="post" name="myForm" enctype="multipart/form-data" >
	     <h1 style="color:lightseagreen" align="center">BIO-DATA</h1>
	    <h3 style="color:lightseagreen" align="center">BASIC INFORMATION:-</h3><br>
           <label>Roll No:</label><br>
		   <input type="text" name="roll" value="<?php echo $roll; ?>" ><br>
		   <input type="hidden" name="hidden" value="<?php echo $roll; ?>" ><br>
		   <label>Name of Candidate:</label><br>
